...
async def main():
    ...
    detect_model_path = r"/home/shanin/Desktop/UNILEVER_Master/AI_Models/ublDA_v8.1.pt"
    root_folder_path = r"/home/shanin/Downloads/November CSD/TRESEMME SHAMPOO KERATIN SMOOTH 580ML"

    desired_class_names = ["tresemme_ks_large", "tresemme_ks_small"] # None or ["gl_aryuvedic_crm"]
    show_full_annotation = False  # False=rectangles, True=full annotations
    initial_padding = 100  # Set your padding value here
...
# conda activate office && python -c "import cv2, os, sys; img=cv2.imread(sys.argv[1]); p=int(sys.argv[2]); cv2.imwrite(os.path.join(sys.argv[3],'padded_'+os.path.basename(sys.argv[1])), cv2.copyMakeBorder(img,p,p,p,p,cv2.BORDER_CONSTANT,value=[0,0,0]))" "/home/shanin/Downloads/November CSD/TRESEMME RRO COND KERATN SMOOTH LC 190ML/a.jpg" 100 "/home/shanin/Desktop"
